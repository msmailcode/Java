	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<!-- 订单开始 -->
			<s:iterator value="buyList" var="catItem" status="i">	
					<tr>
						<td valign="top">
							${i.index+1 }
						</td>
						...
						<td valign="top">
							${catItem.product.dangPrice }
						</td>
						<td valign="top">
							${catItem.qty }
						</td>
						<td valign="top">
							${catItem.product.dangPrice * catItem.qty}
						</td>
					</tr>
			...
			<br />
			<div class="login_in">
				<a href="../cart/cartlist.action"><input id="btnClientRegister" class="button_1" name="submit"
