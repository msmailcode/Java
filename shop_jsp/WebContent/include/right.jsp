    <div class="right_content">
      <div class="cart">
        ...
        <div class="home_cart_content"> 3  items | <span class="red">TOTAL: 100</span> </div>
      ...
      <div class="right_box">
        <div class="title"><span class="title_icon"><img src="images/bullet5.gif" alt="" title="" /></span>分类目录</div>
        <ul class="list">
