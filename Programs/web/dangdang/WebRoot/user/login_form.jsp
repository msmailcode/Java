		...
		<div class="enter_in">
			...
			<div class="center">
				...
				<div class="main">
					...
					<form method="post" id="ctl00" action="../${prePage }">
						<span id="errormsg" style="color:red;">${loginmsg }
						</span>
						<ul>
							<li><span>请输入Email地址：</span> <input type="text" name="name"
								id="txtUsername" class="textbox" />
							</li>
							<li><span class="blank">密码：</span> <input type="password"
								name="password" id="txtPassword" class="textbox" />
							</li>
							<li>
							<!-- <input type="submit" id="btnSignCheck"
								class="button_enter" value="登 录" />
								 -->
								  <input type="button" id="btnSignCheck"
								class="button_enter" value="登 录" onclick="check()"/>
							</li>
						</ul>
