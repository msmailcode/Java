						...
						<tr>
							<td valign="top">
								...
								<TABLE width="96%" border=0 align="center" cellPadding=0
									...
									<TR>
										<TD>
											<IMG hspace=5 src="${pageContext.request.contextPath}/image/NewGoods_06.gif">
										</TD>
									</TR>
								</TABLE>
								<table width="96%" border="0" align="center" cellpadding="0"
										...
										<c:forEach items="${requestScope.arrayList}" var="row" varStatus="status">
											...
											<td nowrap>
												...
												<td width="100" align="center" nowrap>
														...
														target=_blank>
														<img src="${pageContext.request.contextPath}/${row.fileName}" width="60" height="60"
															border="1"> </a>
												</td>
