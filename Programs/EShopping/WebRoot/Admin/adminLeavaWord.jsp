...
<html>
	...
	<script type="text/javascript">
		...
		function f3(){
			...
			if(b){
				//进入删除的servlet将表中的数据全部删除
				window.location.href = "/EShopping/servlet/OutExcelLeaveWord";
			}else {
					...
					<tr>
						<td height="30" class="blueText" align="center">
							<span class="blueText"><a
								href="/EShopping/servlet/AdminMerList" class="blueText">会员管理</a>
							</span>
							<br>
							<br>
						</td>
												...
												<TBODY>
													<TR>
														...
														<TD class=sys_title_right width="100%" align="center">
															&nbsp;
															<FONT class=font_title>留言管理</FONT>&nbsp;
														</TD>
													</TR>
													<tr>
														<td height="30" class="blueText" align="center">
															<span class="blueText"><a
																href="/EShopping/servlet/AdminMerList"
																class="blueText">会员管理</a> 
															</span>
															<br>
															<br>
														</td>
											...
											<TABLE class=datagrid_normal id=DataGrid1
												...
												<TBODY>
													<TR class=datagrid_headerstyle_normal align=middle
														...
														<TD noWrap>
															<A href="adminMerSpe.jsp">留言标题</A>
														</TD>
														<TD noWrap>
															<A href="adminMerSpe.jsp">顾客号</A>
														</TD>
														<TD noWrap>
															<A href="adminMerSpe.jsp">已回复否</A>
														</TD>
														<TD noWrap>
															<A href="adminMerSpe.jsp">留言时间</A>
														</TD>
														<TD noWrap>
															<A href="adminMerSpe.jsp">留言维护</A>
														</TD>
													</TR>
													<page:pager dz="5">
															...
															<page:item nr="${status.count}">
																<TR class=datagrid_itemstyle_normal
																	...
																	<td nowrap align="center">
																		<a href="/EShopping/servlet/ListLeaveWord?id=${row.id}"
																			>留言详情</a>&nbsp;&nbsp;
																		<a href="/EShopping/servlet/DelLeaveWord?id=${row.id}"
																			onclick='return confirm("确定要删除吗?")'>删除留言</a>&nbsp;&nbsp;
																	</td>
