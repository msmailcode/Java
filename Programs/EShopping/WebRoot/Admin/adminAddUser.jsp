			...
			<tr>
				...
				<td>
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td align="center">
							<form action="/EShopping/servlet/ModUserSuccess">
								<table width="94%" border="0" cellpadding="0" cellspacing="1"
									...
									<tr bgcolor="#F7F3F7" class="text">
										...
										<td>
											&nbsp;
											<input type="text" name="adminuserName" value="<%=admin.getAdminuserName()%>">
										</td>
									</tr>
									<tr bgcolor="#F7F3F7" class="text">
										<td width="220" height="26" align="right">
										...
										<td>
											&nbsp;
											<input type="text" name="adminpassWord" value="<%=admin.getAdminpassWord()%>">
										</td>
									</tr>
									<tr bgcolor="#F7F3F7" class="text">
										<td width="220" height="26" align="right">
