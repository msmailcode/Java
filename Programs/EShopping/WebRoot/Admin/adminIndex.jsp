...
<script language="javascript">
	...
	<TD style="WIDTH: 9pt" class="main">
		<TABLE height="100%" border=0 cellPadding=0 cellSpacing=0 background="../image/onOffLeft_back.jpg" style="border-left:1px; border-right:1px; border-color:#d4d0c8; border-style:solid; ">
