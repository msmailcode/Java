...
<html>
	...
	<body class=body_normal>
		...
		<!-- 提交到的位置 -->
		<FORM id=form1 name=form1 action="/EShopping/servlet/FileUpLoadServlet"
			...
			<TABLE class=table_bar id=Table4 width="100%">
				<TBODY>
					<TR>
						<TD style="WIDTH: 100%">
							<INPUT class=button_normal style="WIDTH: 60px" type=button
								value=新增(N) name=btnSaveNew >
							<INPUT class=button_normal type="submit" value=提交(S) name=btnSave>
							<INPUT class=button_normal style="WIDTH: 60px" type=button
								value=编辑(E) name=BtnEdit>
							<INPUT class=button_normal type=button value="关 闭(C)"
								name=btnClose>
						</TD>
					</TR>
				</TBODY>
			...
			<TABLE class=table_bar1 id=Table3 width="100%">
				<TBODY>
					<TR>
						<TD noWrap width=60>
							<SPAN id=Lblproduct_bigclass style="WIDTH: 60px">图书类别</SPAN>
						</TD>
						<TD noWrap width=160>

							<SELECT style="WIDTH: 140px" name=typeid>
						...
						<TD noWrap width=60>
							<SPAN id=Lblproduct_name>图书名称</SPAN>
						</TD>
						<TD noWrap width=160>
							<INPUT class=text_normal style="WIDTH: 140px" name="name">
							<SPAN id=Label1
					...
					<TR>
						<TD noWrap>
							<SPAN id=Lblproduct_spec style="WIDTH: 60px">图书编号</SPAN>
						</TD>
						<TD noWrap>
							<INPUT class=text_normal style="WIDTH: 140px" name="marque">
						</TD>
						<TD noWrap>
							<SPAN id=Lblproduct_model>出版社</SPAN>
						</TD>
						<TD noWrap>
							<INPUT class=text_normal style="WIDTH: 140px" name=descript>
						</TD>
					</TR>
				</TBODY>
			</TABLE>
			...
			<TABLE class=table_bar1 id=Tblbase width="100%">
				<TBODY>
					<TR>
						...
						<TD noWrap width=160>
							<INPUT class=text_normal style="WIDTH: 140px" name=storage>
						</TD>
						<TD noWrap width=60>
							<SPAN id=Lblproduct_unit>计量单位</SPAN>
						</TD>
						<TD noWrap width=160>
							<SELECT style="WIDTH: 140px; HEIGHT: 24px" name=unit>
								<OPTION value=本 selected="selected">
									本
								</OPTION>
								<OPTION value=件>
									件
					...
					<TR>
						...
						<TD noWrap>
							<INPUT class=text_normal style="WIDTH: 140px" name=price>
						</TD>
						<TD noWrap>
							<SPAN id=Lblproduct_cost_price>优惠价</SPAN>
						</TD>
						<TD noWrap>
							<INPUT class=text_normal style="WIDTH: 140px" name=saleprice>
						</TD>
					</TR>
					<TR>
						<TD noWrap>
						...
						<TD noWrap>
							<INPUT class=text_normal style="WIDTH: 140px" name=leavetime
								onfocus="setday(this)" readonly>
						</TD>
						<TD noWrap>
							<SPAN id=Lblproduct_provide>作者</SPAN>
						</TD>
						<TD noWrap>
							<INPUT class=text_normal style="WIDTH: 140px" name=provider>
							<IMG id=Img1
					...
					<TR>
						<TD noWrap>
							<SPAN id=Lblproduct_memo>图书简介</SPAN>
						</TD>
						<TD noWrap colSpan=3>
							<FONT face=宋体><TEXTAREA class=text_normal
									style="WIDTH: 430px" name=contents rows=12></TEXTAREA> </FONT>
						</TD>
					</TR>
				</TBODY>
			</TABLE>
