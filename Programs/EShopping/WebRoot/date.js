...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=160 bordercolor=#6699FF bgcolor=#6699FF Author="wayx">';//表格的颜色。
...
strFrame+='      <tr align=center Author="wayx"><td width=16 align=center bgcolor=#6699FF style="font-size:12px;cursor: hand;color: #ffffff" ';//前翻按钮的颜色。
strFrame+='        onclick="parent.meizzPrevM()" title="向前翻 1 月" Author=meizz><b Author=meizz>&lt;</b>';
strFrame+='        </td><td width=60 align=center style="font-size:12px;cursor:default" Author=meizz ';
strFrame+='onmouseover="style.backgroundColor=\'#CCCCCC\'" onmouseout="style.backgroundColor=\'white\'" ';//鼠标移动到年份上的颜色。
...
strFrame+='<td width=48 align=center style="font-size:12px;cursor:default" Author=meizz onmouseover="style.backgroundColor=\'#CCCCCC\'" ';//鼠标移动到月份上的颜色。
strFrame+=' onmouseout="style.backgroundColor=\'white\'" onclick="parent.tmpSelectMonthInnerHTML(this.innerText.length==3?this.innerText.substring(0,1):this.innerText.substring(0,2))"';//鼠标离开的颜色
strFrame+='        title="点击这里选择月份"><span id=meizzMonthHead Author=meizz></span></td>';
strFrame+='        <td width=16 bgcolor=#6699FF align=center style="font-size:12px;cursor: hand;color: #ffffff" ';//后翻按钮的颜色
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 bgcolor=#6699FF ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');//星期按钮的颜色
...
strFrame+='    <table border=1 cellspacing=2 cellpadding=0 BORDERCOLORLIGHT=#6699FF BORDERCOLORDARK=#FFFFFF bgcolor=#FFFFF width=140 height=120 Author="wayx">';
    ...
    if (meizzWDay[i]!="")
      { 
		...
		else		//本月的部分
		{
			...
			//如果是当前选择的日期，则显示亮蓝色的背景；如果是当前日期，则显示蓝色背景
			if(!outDate)
				da.style.backgroundColor = (yy == new Date().getFullYear() && mm == new Date().getMonth()+1 && meizzWDay[i] == new Date().getDate())?
					"#CFF4FC":"#e0e0e0";//当前日期按钮上的颜色。
			else
			{
				da.style.backgroundColor =(yy==outDate.getFullYear() && mm== outDate.getMonth() + 1 && meizzWDay[i]==outDate.getDate())?
					"#FFFFCC":((yy == new Date().getFullYear() && mm == new Date().getMonth()+1 && meizzWDay[i] == new Date().getDate())?
					"#CFF4FC":"#e0e0e0");
				//将选中的日期显示为凹下去
