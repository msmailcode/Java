						...
						<tr>
							<td valign="top">
								...
								<TABLE width="96%" border=0 align="center" cellPadding=0
									...
									<TR>
										<TD>
											<IMG hspace=5 src="${pageContext.request.contextPath}/image/NewGoods_03.gif">
										</TD>
									</TR>
								</TABLE>
								<table width="96%" border="0" align="center" cellpadding="0"
											...
											<td nowrap>
												...
												<td width="100" nowrap>
													...
													<a href="/EShopping/servlet/TakeCart?id=${row.id}" ><img
															alt="" src="${pageContext.request.contextPath}/image/icon_buy.gif" border=0>
													</a>
												</td>
											</page:item>
											</tr>
