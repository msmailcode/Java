						...
						<tr>
							<td valign="top">
								...
								<TABLE width="96%" border=0 align="center" cellPadding=0
									...
									<TR>
										<TD>
											<IMG hspace=5 src="${pageContext.request.contextPath}/image/NewGoods_04.gif">
										</TD>
									</TR>
								</TABLE>
								<table width="96%" border="0" align="center" cellpadding="0"
									...
									<c:choose>
									<c:when test="${empty requestScope.arrayList5}">
										<tr>
									...
									<c:otherwise>
									<page:pager dz="5">
										<c:forEach items="${requestScope.arrayList5}" var="row" varStatus="status">
